...
const Home = () => {
  ...
  const RedirectURL = `https://api.themoviedb.org/3/movie/?api_key=06ae2dc755080f5934364ba0fb9232fb`
              ...
              ({ title, vote_average, poster_path, overview, id }) => (
                <div key={title} className="item-movies">
                  ...
                  <div className="area-movie-bottom">
                    <p className="text-movie-bottom ">Avaliação: <span className="span-vote" style={{color: vote_average >= 6 ? 'green' : 'red'}}>{vote_average}</span></p>
